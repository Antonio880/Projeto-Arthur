...
const ManageRoom = () => {
  ...
  useEffect(() => {
    const fetchRoomDetails = async () => {
      try {
        if (id) {
          const studentsResponse = await axios.get(`https://2e29-2804-14c-de89-8477-8a2a-7a54-296a-26c0.ngrok-free.app/rooms/${id}/students`);
          setStudents(studentsResponse.data);

          const examsResponse = await axios.get(`https://2e29-2804-14c-de89-8477-8a2a-7a54-296a-26c0.ngrok-free.app/exams/${id}`);
  ...
  const onSubmit = async (data) => {
    try {
      const responseExam = await axios.post(`https://2e29-2804-14c-de89-8477-8a2a-7a54-296a-26c0.ngrok-free.app/exams/create?category=${data.category}&questionCount=${data.questionCount}&roomId=${id}&createdById=${user.id}`);
