        ...
        <div>
            <header className="bg-indigo-200 h-20 flex justify-between px-20">
                ...
                <div className="flex justify-around items-center">
                    ...
                    <button className="py-1 px-3 border-2 border-purple bg-purple rounded-md transition delay-200 hover:bg-darkPurple hover:border-darkPurple text-white" onClick={() => navigate("/login")}>Login</button>
                </div>
            </header>
        </div>
    )
